...
class AppConfig {
     ...
     companion object {
         // 接続先設定
         val YYAPIS_API_KEY = BuildConfig.YYAPIS_API_KEY
         val YYAPIS_ENDPOINT = BuildConfig.YYAPIS_ENDPOINT
         val YYAPIS_PORT = BuildConfig.YYAPIS_PORT
         val YYAPIS_SSL = BuildConfig.YYAPIS_SSL
